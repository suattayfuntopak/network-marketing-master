...
export const TRAINING_VIDEOS: TrainingVideoDef[] = [
  {
    key: 'vid-hayaller',
    youtubeId: 'B89ZUj_7f98',
    titleTr: '1 · Hayaller ve Hedefler',
    titleEn: '1 · Dreams and Goals',
    descriptionTr: "Network marketing'in olmazsa olmazları serisinin ilki. Hayallerini ve hedeflerini netleştir; nereye gittiğini bil.",
    descriptionEn: 'The first of the network marketing essentials series. Clarify your dreams and goals; know where you are going.',
    durationMin: 22,
    categoryTr: 'Hedefler',
    categoryEn: 'Vision & Goals',
  },
  {
    key: 'vid-odaklanma',
    youtubeId: 'dw8BLLRKtGY',
    titleTr: '2 · Odaklanma ve Taahhüt',
    titleEn: '2 · Focus and Commitment',
    descriptionTr: 'Olmazsa olmazlar serisinin 2. videosu: odaklanma ve taahhüt. Dağılmadan, söz verdiğin işe bağlı kalmak.',
    descriptionEn: 'Episode 2 of the essentials series: focus and commitment. Staying committed to what you promised without scattering.',
    durationMin: 18,
    categoryTr: 'Odak',
    categoryEn: 'Focus',
  },
  {
    key: 'vid-kisisel-gelisim',
    youtubeId: 'z-Wxl5eMQzI',
    titleTr: '3 · Kişisel Gelişim: Siz büyüyün, ekibiniz büyüsün',
    titleEn: '3 · Personal Growth: You grow, your team grows',
    descriptionTr: "İşini büyüt: Network Marketing'de kişisel gelişimin gücü. Siz büyüyün, ekibiniz büyüsün. Carol Dweck, Jim Rohn, Eric Worre ve bilimsel araştırmalar.",
    descriptionEn: 'Grow your business: the power of personal development in network marketing. You grow, your team grows. Carol Dweck, Jim Rohn, Eric Worre and research.',
    durationMin: 21,
    categoryTr: 'Kişisel Gelişim',
