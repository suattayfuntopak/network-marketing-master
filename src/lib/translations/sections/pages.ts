export const pagesSection = {
  tr: {
    pagesUi: {
      ...
      bulkDeferOneDay: "Hepsini +1 gün ertele",
      bulkDeferTitle: "Gecikmiş takipleri ertele",
      bulkDeferMessage: "{count} adayın takibi 1 gün ertelenecek. Devam edilsin mi?",
      bulkDeferConfirm: "Evet, ertele",
      bulkDeferSuccess: "{count} takip 1 gün ertelendi",
  ...
  en: {
    pagesUi: {
      ...
      bulkDeferOneDay: "Defer all +1 day",
      bulkDeferTitle: "Defer overdue follow-ups",
      bulkDeferMessage: "{count} follow-ups will be moved forward by 1 day. Continue?",
      bulkDeferConfirm: "Yes, defer",
      bulkDeferSuccess: "{count} follow-ups deferred by 1 day",
