export const statsSection = {
  tr: {
    statsPage: {
      ...
      teamLockedDesc: 'Ekip üyelerinizin aday hunisi değerleri, içerik/video/itiraz takipleri ve doğru başlangıç gelişimlerini “Ekip Performans İzleme Tablosu”nda görmek için planınızı yükseltin.',
  ...
  en: {
    statsPage: {
      ...
      teamLockedDesc: 'Upgrade your plan to see your team members’ candidate pipeline values, content/video/objection progress and onboarding development in the “Team Performance Tracking Table”.',
