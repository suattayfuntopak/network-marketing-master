export const statsSection = {
  tr: {
    statsPage: {
      ...
      quotaCoach: 'Yapay Zeka Koçu (Rol Provası)',
      quotaLeft: 'kalan',
      quotaWriter: 'YZ Mesajı Üret',
  ...
  en: {
    statsPage: {
      ...
      quotaCoach: 'AI Coach (Roleplay)',
      quotaLeft: 'left',
      quotaWriter: 'Write Message (AI Writer)',
      quotaCompliance: 'Compliance Audit',
