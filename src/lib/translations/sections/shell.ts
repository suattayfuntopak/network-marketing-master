export const shellSection = {
  tr: {
    shellUi: {
      ...
      planBlurb_plus: 'Günlük {limit} YZ · DDBR + huni tablosu',
      planBlurb_pro: 'Günlük {limit} YZ · eğitim sütunları + saha özeti',
  ...
  en: {
    shellUi: {
      ...
      planBlurb_plus: 'Daily {limit} AI · Quick Start + funnel table',
      planBlurb_pro: 'Daily {limit} AI · learning columns + field summary',
