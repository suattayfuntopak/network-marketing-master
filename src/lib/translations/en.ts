export const en = {
  ...
  navMobile: {
    ...
    hedefim: "My Goal",
    ekip: "Team",
    sahaOzetim: "Field Summary",
    sahaRadar: "Field Radar",
    canliEgitim: "Live Training",
    more: "More",
    takvim: "Calendar",
  ...
  musteriler: {
    ...
    aiMessageCta: "Generate AI Message",
    aiMessageTitle: "AI Message",
    aiMessageFor: "Generated for {name}",
    aiMessageGenerating: "Generating message…",
    aiMessageCopied: "Message copied!",
    aiMessageError: "Could not generate message.",
    detailBack: "Back to Customers",
    detailSubtitle: "Customer profile",
    detailRegistered: "Registered",
    detailPhone: "Phone",
    detailNote: "Note",
    detailLastOrder: "Last order",
    detailOrdersTitle: "Order History",
    detailNoOrders: "No orders recorded yet.",
    detailEditCta: "Edit",
    detailNotFound: "Customer not found.",
    editTitle: "Edit Customer & Orders",
    editOrdersSection: "Orders",
    editOrderDate: "Date",
    editOrderNote: "Order note",
    editOrderDelete: "Delete order",
    editOrderDeleteConfirm: "Delete this order?",
    editInvalidAmount: "Invalid order amount.",
    customerUpdatedToast: "Customer updated.",
    orderDeletedToast: "Order deleted.",
    deleteCustomerCta: "Delete Customer",
  },
  stages: {
    yeni: "New Prospect",
    iletisim: "Contacted",
  ...
  team: {
    ...
    teamLimitReached: "Team Limit Reached ({limit}/{limit})",
    teamLimitDescBasic: "Basic shows up to {limit} downline members. Upgrade to Plus for a larger team.",
    teamLimitDescPlus: "Plus shows up to {limit} downline members. Upgrade to Pro for unlimited listing.",
    ...
    memberDetailTitle: "Person Detail",
    ...
    memberDetailTemplateIntro:
      "When you generate a Coaching Message, AI uses the text in the box that matches the person's current activity level as personal context. Leave blank and AI writes in its own style.",
    ...
    searchMembersMobile: "Find by name or phone number…",
    searchMembersDesktop: "Find team member by name…",
    callBtn: "Call",
    callMemberHint: "Call {name} ({phone})",
    memberSelfGoalTitle: "Self-set organization goal",
    memberDetailTabs: "Person detail tabs",
