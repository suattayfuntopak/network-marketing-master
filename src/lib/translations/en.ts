export const en = {
  ...
  team: {
    ...
    inviteTeammate: "Send Invite Code",
    inviteTeammateDesc: "Share your invite code or link; whoever signs up joins NMM under your sponsorship.",
    copyCode: "Copy Code",
    waInviteGroup: "Hi! 👋\n\nI'm inviting you to Network Marketing Master — let's grow under my sponsorship with the same system.\n\nRegistration link: {link}",
    joinATeam: "Enter Invite Code",
    joinATeamDesc: "Enter the NMM invite code your leader sent you to join their team. (Only if you're not already linked to a leader.)",
    joinBtn: "Join",
    pasteInvitePlaceholder: "Paste invite code...",
    joinSuccess: "You've joined the team! 🎉",
