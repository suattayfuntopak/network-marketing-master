export const tr = {
  ...
  team: {
    ...
    inviteTeammate: "Davet Kodu Gönder",
    inviteTeammateDesc: "Davet kodunu veya linkini paylaş; tıklayan kişi senin sponsorluğunda NMM'ye kaydolur.",
    copyCode: "Kodu Kopyala",
    waInviteGroup: "Merhaba! 👋\n\nSeni Network Marketing Master'a davet ediyorum — benim sponsorluğumda aynı sistemle ilerleyelim.\n\nKayıt linki: {link}",
    joinATeam: "Davet Kodunu Gir",
    joinATeamDesc: "Liderinin sana gönderdiği NMM davet kodunu gir; onun ekibine bağlanırsın. (Yalnız henüz bir lidere bağlı değilsen.)",
    joinBtn: "Katıl",
    pasteInvitePlaceholder: "Davet kodunu yapıştır...",
    joinSuccess: "Ekibe başarıyla katıldın! 🎉",
