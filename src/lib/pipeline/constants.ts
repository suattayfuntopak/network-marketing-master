...
export const STAGE_COLOR_SEQUENCE: StageColor[] = ['blue', 'purple', 'amber', 'orange', 'emerald', 'pink', 'red', 'gray']
...
export function getRandomReadableStageColor(existingCount = 0): StageColor {
  return STAGE_COLOR_SEQUENCE[existingCount % STAGE_COLOR_SEQUENCE.length]
}
