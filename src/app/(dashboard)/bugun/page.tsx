import { Phone, MessageCircle, Bell, Users, PenLine, CalendarDays, TrendingUp } from 'lucide-react'
    ...
    <main className="min-h-screen bg-white px-4 pb-28 pt-6 md:pb-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          <SquareButton icon={TrendingUp}    label="Pipeline"   color="purple" />
          <SquareButton icon={PenLine}       label="Mesaj Yaz"  color="teal"   />
          <SquareButton icon={Users}         label="Ekibim"     color="amber"  />
          <SquareButton icon={CalendarDays}  label="Takvim"     color="pink"   />
        </div>
      </section>
    </main>
  )
