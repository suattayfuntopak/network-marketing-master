            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-[var(--border)]">
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="rounded-xl bg-[#3730A3] hover:bg-[#28227d] text-white px-5 py-2 md:py-2.5 text-xs md:text-sm font-bold shadow-sm transition active:scale-95 cursor-pointer disabled:opacity-50 flex items-center gap-1.5"
                >
                  {isPending ? (
                    <>
