...
import { STUDIO_ACCENT_BTN_HOVER, STUDIO_MODULE_ACCENT_CLASS } from '@/lib/ui/brandGradients'
...
const TABS: readonly { key: YazarTab; icon: typeof MessageSquare; labelKey: string; activeClass: string }[] = [
  ...
  { key: 'studyo', icon: PenLine, labelKey: 'coachUi.tabStudyo', activeClass: `${STUDIO_MODULE_ACCENT_CLASS} ${STUDIO_ACCENT_BTN_HOVER}` },
