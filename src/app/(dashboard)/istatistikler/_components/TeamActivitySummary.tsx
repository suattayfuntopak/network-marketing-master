    ...
    <section className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-5 space-y-5 animate-in fade-in duration-200">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Sıralama — KPI'lardan hemen sonra, chevron ile açılır/kapanır (varsayılan kapalı) */}
          <div className="rounded-xl border border-[var(--border)]">
            ...
            >
              ...
              <ChevronDown
                className={`h-4 w-4 text-[var(--text-3)] transition-transform ${showRanking ? 'rotate-180' : ''}`}
              />
            </button>
