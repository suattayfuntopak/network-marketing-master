...
export function YZKocuSheet({ candidate, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 rounded-t-3xl bg-[var(--bg-card)] px-5 pb-10 pt-5 shadow-2xl md:left-auto md:right-6 md:top-6 md:bottom-auto md:w-[420px] md:rounded-2xl md:pb-6" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
        {/* Başlık */}
